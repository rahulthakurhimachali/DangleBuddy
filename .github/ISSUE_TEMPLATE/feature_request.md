...
Roughly how you imagine it working. Sketches, references from other apps, or a
description of the interaction are all welcome.
...
Worth a sentence on how yours sits with that.
